      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-3 gap-8">
          ...
          <div className="col-span-2 bg-white rounded-lg p-8">
            ...
            {/* Billing Details */}
            <div className="mb-8">
              <h3 className="text-primary text-[13px] font-bold mb-4">BILLING DETAILS</h3>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-[12px] font-bold mb-2 block">Name</label>
                  <input 
                    type="text" 
                ...
                <div>
                  <label className="text-[12px] font-bold mb-2 block">Email Address</label>
                  <input 
                    type="email" 
              ...
              <div className="mt-4">
                <label className="text-[12px] font-bold mb-2 block">Phone Number</label>
                <input 
                  type="tel" 
            ...
            {/* Shipping Info */}
            <div className="mb-8">
              <h3 className="text-primary text-[13px] font-bold mb-4">SHIPPING INFO</h3>
              <div className="mb-4">
                <label className="text-[12px] font-bold mb-2 block">Address</label>
                <input 
                  type="text" 
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-[12px] font-bold mb-2 block">ZIP Code</label>
                  <input 
                    type="text" 
                    placeholder="10001" 
                    className="w-full border border-gray-300 rounded-lg px-4 py-3 text-[14px] focus:outline-none focus:border-primary"
                ...
                <div>
                  <label className="text-[12px] font-bold mb-2 block">City</label>
                  <input 
                    type="text" 
              ...
              <div className="mt-4">
                <label className="text-[12px] font-bold mb-2 block">Country</label>
                <input 
                  type="text" 
            ...
            {/* Payment Details */}
            <div>
              <h3 className="text-primary text-[13px] font-bold mb-4">PAYMENT DETAILS</h3>
              ...
              <div className="bg-gray-50 rounded-lg p-6 flex gap-4">
                <svg className="w-12 h-12 flex-shrink-0" viewBox="0 0 48 48" fill="none">
                  <circle cx="24" cy="24" r="24" fill="#D87D4A" opacity="0.3"/>
                  <path d="M24 16v16M16 24h16" stroke="#D87D4A" strokeWidth="2" strokeLinecap="round"/>
                </svg>
                <p className="text-[14px] text-gray-600 leading-relaxed">
                  The 'Cash on Delivery' option enables you to pay in cash when our delivery courier arrives at your residence. Just make sure your address is correct so there's no issues.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-lg p-6">
              ...
              <div className="space-y-6 mb-6">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-gray-600 text-[15px] font-bold">x1</span>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-gray-600 text-[15px] font-bold">x2</span>
                </div>
              ...
              <div className="space-y-2 mb-6">
                ...
                <div className="flex justify-between">
                  <span className="text-gray-600 text-[15px]">VAT (INCLUDED)</span>
              ...
              <div className="flex justify-between mb-6 pt-4">
                ...
                <span className="font-bold text-[18px] text-primary">$ 5,446</span>
              </div>
