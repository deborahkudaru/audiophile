...
//       setErrors({ 
//         name: err instanceof Error ? err.message : "Checkout failed. Please try again." 
//       });
//     } finally {
//       setLoading(false);
//     }
...
//               {form.payment === "cod" && (
//                 <div className="mt-4 flex items-start gap-4 p-4 bg-gray-100 rounded-lg">
//                   <svg className="w-12 h-12 shrink-0 text-primary" viewBox="0 0 48 48" fill="currentColor">
...
//               <h3 className="text-[18px] font-bold mb-6 tracking-wider">SUMMARY</h3>
...
//                       <span className="text-gray-600 text-[15px] uppercase">Total</span>
//                       <span className="font-bold text-[18px]">$ {subtotal.toLocaleString()}</span>
//                     </div>
//                     <div className="flex justify-between">
//                       <span className="text-gray-600 text-[15px] uppercase">Shipping</span>
...
//                     <span className="text-gray-600 text-[15px] uppercase">Grand Total</span>
