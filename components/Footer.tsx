  ...
  return (
    <div className="bg-dark text-white px-6 md:px-12 lg:px-20 py-10 lg:text-left md:text-left text-center">
      <nav className="flex flex-col lg:flex-row lg:justify-between py-4 lg:items-center">
        ...
        <ul className="flex flex-col md:flex-row gap-4 font-light text-sm">
          <li>
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between lg:items-end py-8">
        <p className="font-medium text-[15px] leading-[25px] max-w-[540px] text-white/50 mb-12 lg:mb-0">
