...
export default function Footer() {
  return (
    <div className="bg-dark text-white px-20 py-10">
      <nav className="flex justify-between py-4 items-center">
        ...
        <ul className="flex gap-4 font-light text-sm self-end">
          <li>
            <Link href="/">HOME</Link>
          </li>
          <li>
      ...
      <div className="flex justify-between items-end">
        <p className="font-medium text-[15px] leading-[25px] max-w-[540] text-white/50">
      ...
      <p className="font-meidum text-[15px] mt-12 text-white/50">
